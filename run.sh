...
./pte/pte -nodes ${output_path}new.all.words.node -words ${output_path}new.all.words.node -enhin ${output_path}en.ww.net -zhhin ${output_path}zh.ww.net -enlinkhin ${output_path}en.linkage.net -zhlinkhin ${output_path}zh.linkage.net -clhin ${output_path}cl.train.40000.net -output ${output_path}align.word.emb -binary 0 -size 5 -negative 5 -samples 10000 -alpha 0.025 -lr_1 0.01 -MARGIN 1.0 -lambda_1 1.0 -lr_2 0.01 -lambda_2 1.0 -threads 25
